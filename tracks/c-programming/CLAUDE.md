...
- **Vim and GDB steps per problem.** For every problem discussed — whether in chat or in a written .md — include specific Vim commands and a GDB workflow tied to that problem. Only use commands already introduced in the progressions files.
